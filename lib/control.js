...
define(['./control-response.js', './utils.js'],

	function(ControlResponse, Utils) {
		...
		function Control() {
			...
			this.create = function(arguments) {
				switch (arguments.length) {
						case 1: this.createFromRequest(arguments[0]);
										break;
						case 2: this.createFromParameters(arguments[0], arguments[1]);
										break;
						case 3: this.createFromParameters(arguments[0], arguments[1], arguments[2]);
										break;
						default: throw TypeError(Control.CONSTRUCTOR_TYPE_ERROR);
					}
			}
