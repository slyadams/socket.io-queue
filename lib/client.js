...
define(['./client-message.js', './control.js', './control-response.js', './utils.js', 'events', 'socket.io-client', 'debug'],

  function(ClientMessage, Control, ControlResponse, Utils, events, io, Debug) {
    ...
    function Client(url, socket) {
      ...
      if ((url == undefined || typeof(url) != 'string') ||
          (socket != undefined && typeof(socket) != 'object')) {
            throw TypeError("Expected string and socket");
      }
